...
var themes = map[string]Theme{
	...
	// Catppuccin Mocha, the palette half of GitHub is wearing.
	"catppuccin": {
		Bg: vt.RGB(0x31, 0x32, 0x44), Fg: vt.RGB(0xcd, 0xd6, 0xf4), Dim: vt.RGB(0xa6, 0xad, 0xc8),
		Accent: vt.RGB(0xcb, 0xa6, 0xf7), Border: vt.RGB(0x45, 0x47, 0x5a),
		TabBg: vt.RGB(0x18, 0x18, 0x25), TabFg: vt.RGB(0xba, 0xc2, 0xde),
		TabActiveBg: vt.RGB(0x89, 0xb4, 0xfa), TabActiveFg: vt.RGB(0x1e, 0x1e, 0x2e),
	},
	// Catppuccin Latte: the same palette for a light terminal.
	"latte": {
		Bg: vt.RGB(0xe6, 0xe9, 0xef), Fg: vt.RGB(0x4c, 0x4f, 0x69), Dim: vt.RGB(0x6c, 0x6f, 0x85),
		Accent: vt.RGB(0x88, 0x39, 0xef), Border: vt.RGB(0xbc, 0xc0, 0xcc),
		TabBg: vt.RGB(0xdc, 0xe0, 0xe8), TabFg: vt.RGB(0x5c, 0x5f, 0x77),
		TabActiveBg: vt.RGB(0x1e, 0x66, 0xf5), TabActiveFg: vt.RGB(0xef, 0xf1, 0xf5),
	},
	"tokyo-night": {
		Bg: vt.RGB(0x29, 0x2e, 0x42), Fg: vt.RGB(0xc0, 0xca, 0xf5), Dim: vt.RGB(0xa9, 0xb1, 0xd6),
		Accent: vt.RGB(0x7a, 0xa2, 0xf7), Border: vt.RGB(0x3b, 0x42, 0x61),
		TabBg: vt.RGB(0x16, 0x16, 0x1e), TabFg: vt.RGB(0xa9, 0xb1, 0xd6),
		TabActiveBg: vt.RGB(0x7a, 0xa2, 0xf7), TabActiveFg: vt.RGB(0x1a, 0x1b, 0x26),
	},
	"dracula": {
		Bg: vt.RGB(0x44, 0x47, 0x5a), Fg: vt.RGB(0xf8, 0xf8, 0xf2), Dim: vt.RGB(0xa4, 0xac, 0xd4),
		Accent: vt.RGB(0xbd, 0x93, 0xf9), Border: vt.RGB(0x62, 0x72, 0xa4),
		TabBg: vt.RGB(0x28, 0x2a, 0x36), TabFg: vt.RGB(0xf8, 0xf8, 0xf2),
		TabActiveBg: vt.RGB(0xff, 0x79, 0xc6), TabActiveFg: vt.RGB(0x28, 0x2a, 0x36),
	},
	"solarized": {
		Bg: vt.RGB(0x07, 0x36, 0x42), Fg: vt.RGB(0x93, 0xa1, 0xa1), Dim: vt.RGB(0x83, 0x94, 0x96),
		Accent: vt.RGB(0x2a, 0xa1, 0x98), Border: vt.RGB(0x58, 0x6e, 0x75),
		TabBg: vt.RGB(0x00, 0x2b, 0x36), TabFg: vt.RGB(0x93, 0xa1, 0xa1),
		TabActiveBg: vt.RGB(0x26, 0x8b, 0xd2), TabActiveFg: vt.RGB(0x00, 0x2b, 0x36),
	},
	// For terminals with a light background or no colour worth the name.
	"mono": {
		Bg: vt.Indexed(15), Fg: vt.Indexed(0), Dim: vt.Indexed(8),
		Accent: vt.Indexed(0), Border: vt.Indexed(8),
		TabBg: vt.Indexed(7), TabFg: vt.Indexed(0),
		TabActiveBg: vt.Indexed(0), TabActiveFg: vt.Indexed(15),
	},
}
