...
export function Look() {
  ...
  return (
    ...
    >
      ...
      <div className="[&>*]:min-w-0 mt-[var(--block-gap)] grid items-start gap-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:gap-12">
        <div className="glass min-w-0 rounded-2xl p-3 sm:p-4">
          <Session theme={theme} borderStyle={border} rows={16} start={["shell", "logs"]} />
        </div>
